namespace _03.Extension_Methods_Delegates_Lambda_LINQ
{
    ...
    using _06.Divisible_by_7_and_3;
    using _07.Timer;
    ...
    public class Startup
    {
        public static void Main()
        {
            ...
            //TestLINQquery.Test();
            //Console.WriteLine();
            //TestDivisibleBy7and3.Test();
            //Console.WriteLine();
            //TestTimers.Test();
            //Console.WriteLine();
            TestStudentsLINQ.Test();
            //Console.WriteLine();
            //LongestString.Test();
        }
    }
...
before its last name alphabetically.
...
class that has properties – FullName and Marks.
Use LINQ.
...
series with given precision depending on a function of its term. By using proper functions for 
the term calculate with a 2-digit precision the sum of the infinite series:
