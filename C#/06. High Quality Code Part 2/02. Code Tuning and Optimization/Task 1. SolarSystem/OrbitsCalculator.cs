...
namespace SolarSystem
{
    class OrbitsCalculator : INotifyPropertyChanged
    {
        ...
        {
            // Made 'step' double, removed unnecessary cast to double 
            // Increment 'step' by 1 each cycle of the loop
            // Removed division to EarthRotationPeriod which is always 1
